...
<body class="ui-mobile-viewport">
	<div data-role="page" id="home" data-url="home" tabindex="0"
		class="ui-page ui-body-c ui-page-active" style="min-height: 909px;">
		...
		<div data-role="content" class="ui-content" role="main">
			<div data-role="fieldcontain" class="ui-field-contain ui-body ui-br">
				<label for="select-choice-1" class="select ui-select">总人数</label> <span
					class="ui-select"> <input type="range" name="slider"
					id="select-choice-1" value="8" min="6" max="16" />
				</span>
			</div>
			<div data-role="fieldcontain" class="ui-field-contain ui-body ui-br">
				<label for="select-choice-2" class="select ui-select"><img
					src="assets/img/wolf.png" width="31px" />狼人数</label>
					<span
					class="ui-select"> <input type="range" name="slider"
					id="select-choice-2" value="3" min="2" max="6" />
				</span>
			</div>
			<div data-role="fieldcontain" class="ui-field-contain ui-body ui-br">
				<label class="select ui-select"><img
					src="assets/img/seer.png" width="31px" />先知</label>
				<div class="ui-select">
			...
			<div data-role="fieldcontain" class="ui-field-contain ui-body ui-br">
				<label class="select ui-select"><img
					src="assets/img/witch.png" width="31px" />女巫</label>
				<div class="ui-select">
					<select name="slider" id="slider" data-role="slider">
						<option value="off">关闭</option>
						<option value="on" selected>开启</option>
			...
			<div data-role="fieldcontain" class="ui-field-contain ui-body ui-br">
				<label class="select ui-select"><img
					src="assets/img/thief.png" width="31px" />盗贼</label>
				<div class="ui-select">
					<select name="slider" id="slider" data-role="slider">
						<option value="off">关闭</option>
						<option value="on" selected>开启</option>
			...
			<div data-role="fieldcontain" class="ui-field-contain ui-body ui-br">
				<label class="select ui-select"><img
					src="assets/img/hunter.png" width="31px" />猎人</label>
				<div class="ui-select">
					<select name="slider" id="slider" data-role="slider">
						<option value="off">关闭</option>
						<option value="on" selected>开启</option>
			...
			<div data-role="fieldcontain" class="ui-field-contain ui-body ui-br">
				<label class="select ui-select"><img
					src="assets/img/cupid.png" width="31px" />丘比特</label>
				<div class="ui-select">
					<select name="slider" id="slider" data-role="slider">
						<option value="off">关闭</option>
						<option value="on" selected>开启</option>
			...
			<div data-role="fieldcontain" class="ui-field-contain ui-body ui-br">
				<label class="select ui-select"><img
					src="assets/img/villager.png" width="31px" />普通村民</label>
				<div class="ui-select">
					 
				</div>
			</div>
			<div data-role="fieldcontain" class="ui-field-contain ui-body ui-br">
				<input type="submit" value="确定开始" />
			</div>
		</div>
	</div>
</body>
